...
n.logData = (data) => { console.log(" Out: " + data); }
...
n.getNavListParent().addEventListener("click", (e) => {
  e.preventDefault();
...
//todo add eventL. to document loaded   & document change for menu creation method